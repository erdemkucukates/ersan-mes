var ERSAN_NAV = [
  ...
  { group: 'Destek', collapsed: true, items: [
    ...
    { label: 'Personel Defteri',    href: 'ersan_ik_personel.html' },
    { label: 'Yetkinlik Matriksi', href: 'ersan_ik_matris.html' },
    { label: 'E\u011Fitim Plan\u0131',     href: 'ersan_ik_egitim.html' },
  ...
  { group: '\u0130\u00E7 Denetim', collapsed: false, items: [
    { label: 'Denetim Paneli',    href: 'ersan_denetim_panel.html' },
    { label: 'Denetim Plan\u0131',     href: 'ersan_denetim_plan.html' },
    { label: 'Denetim Y\u00FCr\u00FCtme', href: 'ersan_denetim_yurutme.html' },
    { label: 'Bulgular',          href: 'ersan_bulgular.html' },
    { label: 'CAPA',              href: 'ersan_denetim_capa.html' },
    { label: 'Denetim Raporlar\u0131', href: 'ersan_denetim_raporlar.html' },
  ]},
